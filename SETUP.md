...
- Vercel can pass the build stage after adding a `build` script, but this JSON-file storage model is not reliable on Vercel serverless functions because filesystem writes are not persistent.
